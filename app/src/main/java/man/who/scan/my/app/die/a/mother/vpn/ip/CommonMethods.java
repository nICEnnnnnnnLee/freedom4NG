package man.who.scan.my.app.die.a.mother.vpn.ip;
...
public class CommonMethods {
	...
	public static int ipStringToInt(String ip) {
		...
		int r = (Integer.parseInt(arrStrings[0]) << 24) | (Integer.parseInt(arrStrings[1]) << 16)
				| (Integer.parseInt(arrStrings[2]) << 8) | Integer.parseInt(arrStrings[3]);
		return r;
	}

	public static byte[] ipStringToBytes(String ip) {
		String[] arrStrings = ip.split("\\.");
		byte[] r = { (byte) (Integer.parseInt(arrStrings[0]) & 0xff), (byte) (Integer.parseInt(arrStrings[1]) & 0xff),
				(byte) (Integer.parseInt(arrStrings[2]) & 0xff), (byte) (Integer.parseInt(arrStrings[3]) & 0xff)};
		return r;
	}
