...
//        }
        ...
        channel = OkHttpChannelBuilder.forAddress(vpnConfig.remoteHost, vpnConfig.remotePort)
                .sslSocketFactory(
                        new MSSLSocketFactory(TrustAllSSLUtil.getSSLContext(vpnConfig.verifySSL).getSocketFactory())
                )
...
//				System.out.println(t.getMessage());
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            Stream.FreedomRequest request = Stream.FreedomRequest.newBuilder().setData(ByteString.copyFromUtf8(sb.toString())).build();
